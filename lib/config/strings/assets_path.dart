class IconsPath {
  ...
  // ABOUT US //
  static const clock = '${_aboutUsIconsPath}clocke.svg';
  static const dollar = '${_aboutUsIconsPath}Dollar.svg';
  static const handShake = '${_aboutUsIconsPath}Handshake.svg';
  static const like = '${_aboutUsIconsPath}Like.svg';
  static const location = '${_aboutUsIconsPath}Location.svg';
  static const replay = '${_aboutUsIconsPath}Replay.svg';
  static const wourd = '${_aboutUsIconsPath}wourd.svg';
  static const blackBox = '${_aboutUsIconsPath}black.svg';

  // SERVICES //
  static const arrowRight = '${_servicesIconsPath}Arrow - Left.svg';
  static const arrowLeft = '${_servicesIconsPath}Arrow - right.svg';
  static const militaryAward = '${_servicesIconsPath}Military-Award.svg';
  static const container = '${_servicesIconsPath}container.png';
...
class ImagesPath {
  ...
  // PNGs //
  static const office = '${_pngImagesPath}office.png';
  static const builder = '${_pngImagesPath}builder.png';
  static const web = '${_pngImagesPath}web.png';
